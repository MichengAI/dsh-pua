...
Requires Node.js 22.19 or later and DSH `0.1.2-rc.1`, `0.1.5-rc.1`, `0.1.5-rc.2`, `0.1.7-rc.1`, or `0.1.7-rc.2`. Uses your existing DSH model configuration; no additional API key is needed.
